...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("update_device_fields", {"name": "device-1", "fields": {"status": "active"}}),
        (
            "bulk_update_device_fields",
            {"updates": [{"name": "device-1", "tenant": "tenant-1", "fields": {"status": "active"}}]},
        ),
        (
            "bulk_add_or_update_interfaces",
            {"interfaces": [{"name": "Gi0/1", "device": "device-1", "tenant": "tenant-1"}]},
        ),
